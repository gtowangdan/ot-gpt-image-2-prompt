...
Vous y trouverez une collection organisée de **862+ prompts GPT-Image-2 de grande qualité**, de modèles d'utilisation de l'API et de workflows visuels réutilisables pour la génération d'images par IA.
...
> **17 cas sélectionnés** — [Explorer tous les prompts de création publicitaire →](cases/ad-creative.md)
...
> **122 cas organisés** — [Explorer tous les prompts portrait →](cases/portrait.md)
...
> **139 cas sélectionnés** — [Explorer tous les prompts d’affiches →](cases/poster.md)
...
> **35 cas sélectionnés** — [Explorer tous les prompts UI et mockup →](cases/ui.md)
