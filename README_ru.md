...
Это тщательно отобранная коллекция из **862+ качественных промптов GPT-Image-2**, паттернов работы с API и переиспользуемых визуальных workflow для генерации изображений с AI.
...
> **17 отобранных кейсов** — [Все промпты для рекламных креативов →](cases/ad-creative.md)
...
> **122 отобранных кейса** — [Все промпты для портретов →](cases/portrait.md)
...
> **139 отобранных кейсов** — [Все промпты для постеров →](cases/poster.md)
...
> **35 отобранных кейсов** — [Все промпты для UI и мокапов →](cases/ui.md)
