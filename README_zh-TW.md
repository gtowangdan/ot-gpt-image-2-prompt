...
精選收錄 **862+ 個高品質 GPT-Image-2 提示詞**、API 使用模式與可重用視覺工作流，面向 AI 圖像生成實作。
...
> **17 個精選案例** — [瀏覽全部廣告創意提示詞 →](cases/ad-creative.md)
...
> **139 個精選案例** — [瀏覽全部海報提示詞 →](cases/poster.md)
...
> **35 個精選案例** — [瀏覽全部 UI 與 Mockup 提示詞 →](cases/ui.md)
