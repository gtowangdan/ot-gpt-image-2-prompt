...
Esta é uma coleção curada de **862+ prompts GPT-Image-2 de alta qualidade**, padrões de uso da API e fluxos visuais reutilizáveis para geração de imagens com IA.
...
> **17 casos selecionados** — [Explorar todos os prompts de criativos publicitários →](cases/ad-creative.md)
...
> **122 casos curados** — [Explore todos os prompts de retrato →](cases/portrait.md)
...
> **139 casos selecionados** — [Explorar todos os prompts de pôster →](cases/poster.md)
...
> **35 casos selecionados** — [Explorar todos os prompts de UI e mockup →](cases/ui.md)
